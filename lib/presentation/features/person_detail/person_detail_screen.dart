...
//           child: FutureBuilder<PersonEntity>(
//               future: Api().fetchPerson(widget.actorId),
//               builder: (context, snapshot) {
//                 PersonEntity? person = snapshot.data;
...
//                               ),
//                             ),
//                             FutureBuilder<CreditsPersonEntity>(
//                               future: Api().fetchPersonCredits(widget.actorId),
//                               builder: (context, snapshot) {
//                                 if (snapshot.connectionState !=
//                                         ConnectionState.waiting &&
//                                     snapshot.hasData) {
//                                   List<CreditPersonEntity> creditsListAsActor =
//                                       snapshot
//                                           .data!.cast
//                                           .where((element) =>
...
//                                               element.title != null)
//                                           .toList();
//                                   List<CreditPersonEntity>?
//                                       creditsListAsProduction = snapshot
//                                           .data?.crew!
//                                           .where(
